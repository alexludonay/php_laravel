...
{!! Form::close() !!}
    @if (Auth::user()->role =="admin")
        <a href="{{ route("admin.users.create")}}"><input class="btn btn-primary center-block" type="submit" style="margin-top: 15px;" value="Créer un utilisateur"/></a>
    @endif
</div>
@foreach($users as $user)
    <div class="col-md-6 col-sm-12 col-lg-4  text-center profil-utilisateurs">
        ...
        <a href="{!! route("profil.show", $user->id) !!}"><input class="btn btn-default center-block" type="submit" value="Voir le Profil"/></a>
            ...
            <a href="{{ route("admin.users.destroy",$user->id)}}"><input type="submit" value="Supprimer" class="del btn btn-danger"/></a>
